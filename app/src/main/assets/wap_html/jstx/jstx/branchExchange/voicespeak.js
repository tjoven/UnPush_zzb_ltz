$(function(){
	...
	$("#speakButton").css("background","url('start_speak.png') no-repeat");
	...
	$("#speakButton").click(function(){
		...
		if (isAndriod) {
			if ("朗读" == $this.attr("speak_status")) {
				...
				$this.css("background","url('stop_speak.png') no-repeat");
			} else if ("暂停" == $this.attr("speak_status")) {
				window.webview.pauseSpeaking();
				$this.attr("speak_status","继续");
				$this.css("background","url('start_speak.png') no-repeat");
